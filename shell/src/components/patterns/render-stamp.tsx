 ...
 *
 * (Live remote versions used to live in this popover too — moved to the
 * sidebar footer, which is always on screen, so it's worth fetching eagerly
 * server-side; see shell/src/lib/remote-versions.ts.)
 */
